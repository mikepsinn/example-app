(function () {
  ...
  function updateElement () {
    ...
    function getOption (optionName) {
      ...
      console.log(optionName + ' is ' + optionValue)
      return optionValue
    }
    ...
    function getAPIQueryString () {
      ...
      if (getClientId() && getClientId() !== '') {
        console.log('clientId is ' + getClientId())
    ...
    window.QuantiModoIntegration.qmSetupIonicPopupIframe = function (state) {
      ...
      window.onload = function () {
        ...
        qmMain.innerHTML = '<iframe style="height:100%;width:100%;" id="ionic-app-frame" src="https://app.quantimo.do/ionic/Modo/src/index.html#' + statePath + '" frameborder="0"></iframe>'
        showPopup()
        showLoader(false)
      }
    }
    ...
    window.QuantiModoIntegration.createSingleFloatingActionButton = function () {
      console.log('called QuantiModoIntegration.createSingleFloatingActionButton')
      ...
      var iFrameUrl = getApiUrl() + '/ionic/Modo/www/index.html#/app/' + window.QuantiModoIntegration.options.defaultState + getIframeQueryString()
      console.log('iFrameUrl is ' + iFrameUrl)
      ...
      createNewDiv(qmPageElements.singleFloatingActionButton)
      if (!qmPageElements.singleFloatingActionButton.element) { qmPageElements.singleFloatingActionButton.element = document.getElementById(qmPageElements.singleFloatingActionButton.id) }
      showElement(qmPageElements.singleFloatingActionButton.element, 5000)
    }
    ...
    getAppSettings(window.QuantiModoIntegration.createSingleFloatingActionButton)
  }
